...
import { INotificacion } from 'app/shared/model/notificacionesmicroservicios/notificacion.model';
...
export class NotificacionService {
  public resourceUrl = SERVER_API_URL + 'services/notificacionesmicroservicios/api/notificacions';
