...
describe('Notificacion e2e test', () => {
  ...
  it('should load Notificacions', async () => {
    ...
    expect(await notificacionComponentsPage.getTitle()).to.eq('gatewaystoreApp.notificacionesmicroserviciosNotificacion.home.title');
    await browser.wait(
  ...
  it('should load create Notificacion page', async () => {
    ...
    expect(await notificacionUpdatePage.getPageTitle()).to.eq(
      'gatewaystoreApp.notificacionesmicroserviciosNotificacion.home.createOrEditLabel'
    );
  ...
  it('should delete last Notificacion', async () => {
    ...
    expect(await notificacionDeleteDialog.getDialogTitle()).to.eq(
      'gatewaystoreApp.notificacionesmicroserviciosNotificacion.delete.question'
    );
